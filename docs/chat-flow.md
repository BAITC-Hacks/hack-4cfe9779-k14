...
4. `DeterministicDialogueRouter` сначала распознаёт SKU, сертификаты, наличие, характеристики, цены, аналоги и условия покупки. Follow-up вроде «а сертификат у него есть?» получает артикул только из той же сессии.
